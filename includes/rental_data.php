...
function get_rental_banners(): array
{
    $all = [
        ...
        ['label' => '전기차 렌트', 'badge' => 'bg-red-600',    'title' => "전기차 장기렌트\n충전비 걱정 없이 타세요",            'desc' => 'EV 보조금 적용 · 충전카드 포함 · 선납금 0원',                  'button' => '전기차 견적보기', 'target' => '고객센터', 'image' => 'banners/big/elec.png',                                'mobCardImg' => '../cars/cdn_4624.png', 'mobIconBg' => '#f0fdf4', 'textDark' => true],
