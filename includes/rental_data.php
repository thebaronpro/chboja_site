...
function get_mob_cars(): array
{
    return [
        ...
        ['tag' => '특가', 'name' => '현대 캐스퍼',     'trim' => '인스퍼레이션 1.0T',       'price' => '월 250,000원', 'price30' => '월 220,000원', 'meta' => '선납금 0원 · 48개월', 'image' => '../cars/cdn_4671.png', 'stock' => 76, 'cat' => ['생에 첫 차','SUV']],
        ['tag' => '특가', 'name' => '기아 레이',       'trim' => '시그니처 1.0',            'price' => '월 230,000원', 'price30' => '월 200,000원', 'meta' => '선납금 0원 · 48개월', 'image' => '../cars/307_4689.png', 'stock' => 88, 'cat' => ['생에 첫 차']],
        ['tag' => '특가', 'name' => '기아 모닝',       'trim' => '시그니처 1.0',            'price' => '월 210,000원', 'price30' => '월 180,000원', 'meta' => '선납금 0원 · 48개월', 'image' => '../cars/cdn_4554.png', 'stock' => 64, 'cat' => ['생에 첫 차']],
        ['tag' => '특가', 'name' => '현대 베뉴',       'trim' => '플럭스 1.6',              'price' => '월 270,000원', 'price30' => '월 240,000원', 'meta' => '선납금 0원 · 48개월', 'image' => '../cars/303_3654.png', 'stock' => 42, 'cat' => ['생에 첫 차','SUV']],
        ['tag' => '인기', 'name' => '현대 코나',       'trim' => '인스퍼레이션 1.6T',       'price' => '월 360,000원', 'price30' => '월 320,000원', 'meta' => '선납금 0원 · 48개월', 'image' => '../cars/303_4361.png', 'stock' => 35, 'cat' => ['생에 첫 차','SUV']],
        ['tag' => '인기', 'name' => '기아 셀토스',     'trim' => '시그니처 1.6T',           'price' => '월 350,000원', 'price30' => '월 310,000원', 'meta' => '선납금 0원 · 48개월', 'image' => '../cars/cdn_4391.png', 'stock' => 47, 'cat' => ['생에 첫 차','SUV']],
        ['tag' => '신차', 'name' => '기아 EV3',       'trim' => '롱레인지 어스',           'price' => '월 420,000원', 'price30' => '월 370,000원', 'meta' => '선납금 0원 · 48개월', 'image' => '../cars/307_4647.png', 'stock' => 22, 'cat' => ['생에 첫 차','전기차','SUV']],
        ['tag' => '신차', 'name' => '캐스퍼 일렉트릭', 'trim' => '인스퍼레이션',            'price' => '월 320,000원', 'price30' => '월 285,000원', 'meta' => '선납금 0원 · 48개월', 'image' => '../cars/cdn_4653.png', 'stock' => 51, 'cat' => ['생에 첫 차','전기차','SUV']],
