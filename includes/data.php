...
if (defined('CHABOZA_DATA_LOADED')) return;
define('CHABOZA_DATA_LOADED', true);

const NAV_ITEMS = [
    ['label' => '홈',         'href' => 'index.php',      'dir' => ''],
    ['label' => '장기렌트',   'href' => 'rental/',        'dir' => 'rental'],
    ['label' => '할부',       'href' => 'installment/',   'dir' => 'installment'],
    ['label' => '중고차',     'href' => 'used-car/',      'dir' => 'used-car'],
    ['label' => '화물리스',   'href' => 'lease/',         'dir' => 'lease'],
    ['label' => '자동차용품', 'href' => 'shop/',          'dir' => 'shop'],
    ['label' => '이벤트&혜택','href' => 'event/',         'dir' => 'event'],
    ['label' => '고객센터',   'href' => 'contact/',       'dir' => 'contact'],
];
...
function get_installment_banners(): array
{
    return [
...
function get_main_banners(): array
{
    return [
...
function get_popular_cars(): array
{
    return [
...
{
    $names = ['3M Crystalline 70', 'LLumar CTX 70', 'V-KOOL 40', 'Huper Optik Neo 65',
              'Solar Gard Stratos', 'XPEL Prime XR Plus', '3M Ceramic IR 40', 'Johnson Window Films'];
    $prices = ['720,000원~','580,000원~','490,000원~','420,000원~','380,000원~','850,000원~','620,000원~','320,000원~'];
    $images = [IMG['tint'], IMG['product'], IMG['tint'], IMG['product'], IMG['tint'], IMG['product'], IMG['tint'], IMG['product']];
...
function get_events(): array
{
    return [
        ...
        ['title' => '화물리스 보증금 면제',       'desc' => '1톤~5톤 전 차종 보증금 0원 적용',       'date' => '2026.04.01 ~ 2026.06.30', 'open' => true,  'image' => null],
        ['title' => '블랙박스 무료 설치',         'desc' => '장기렌트 계약 시 블랙박스 무상 설치',   'date' => '2026.04.10 ~ 2026.04.30', 'open' => true,  'image' => null],
        ['title' => '카시트 구매 20% 할인',       'desc' => '렌트 계약 고객 카시트 할인권 제공',     'date' => '2026.04.01 ~ 2026.05.31', 'open' => true,  'image' => null],
        ['title' => '전기차 충전기 설치비 지원', 'desc' => 'EV 렌트 계약 고객 50% 지원',            'date' => '2026.04.01 ~ 2026.06.30', 'open' => true,  'image' => null],
        ['title' => '신차 할부 금리 우대',         'desc' => 'KB·현대캐피탈 금리 0.5% 추가 인하',     'date' => '2026.02.01 ~ 2026.03.31', 'open' => false, 'image' => null],
        ['title' => '용품점 연결 첫 이용 혜택',   'desc' => '첫 이용 시 5만원 즉시 할인',            'date' => '2026.01.01 ~ 2026.03.31', 'open' => false, 'image' => null],
        ['title' => '카카오 간편 상담 이벤트',   'desc' => '카카오톡 상담 신청 시 견적 즉시 발송',  'date' => '2026.01.15 ~ 2026.03.15', 'open' => false, 'image' => null],
        ['title' => '렌트·리스 패키지 특가',     'desc' => '출고 후 용품 패키지 세트 30% 할인',     'date' => '2026.02.01 ~ 2026.03.31', 'open' => false, 'image' => null],
    ];
}
